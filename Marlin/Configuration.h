...
#define STRING_CONFIG_H_AUTHOR "(bluesforte, Ender-3)" // Who made the changes.
...
//#define RGBW_LED
  ...
  #define RGB_LED_R_PIN P1_28 // X+ bottom pin on SKR v1.3
  #define RGB_LED_G_PIN P1_26 // Y+ bottom pin on SKR v1.3
  #define RGB_LED_B_PIN P1_24 // Z+ bottom pin on SKR v1.3
